...
void AAthena_Prop_SneakySnowman_C::BuildingActorHit(class AActor* SelfActor, class AActor* OtherActor, struct FVector NormalImpulse, struct FHitResult Hit)
{
	static auto fn = UObject::FindObject<UFunction>("Function Athena_Prop_SneakySnowman.Athena_Prop_SneakySnowman_C.BuildingActorHit");

	AAthena_Prop_SneakySnowman_C_BuildingActorHit_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Athena_Prop_SneakySnowman.Athena_Prop_SneakySnowman_C.PostLevelSaveSpawnCleanup");

	AAthena_Prop_SneakySnowman_C_PostLevelSaveSpawnCleanup_Params params;
