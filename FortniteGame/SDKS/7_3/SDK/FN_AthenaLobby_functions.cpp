...
// Function AthenaLobby.AthenaLobby_C.BndEvt__AthenaMatchmakingPlay_K2Node_ComponentBoundEvent
// (BlueprintEvent)
// Parameters:
...
void UAthenaLobby_C::BndEvt__AthenaMatchmakingPlay_K2Node_ComponentBoundEvent(struct FPlaylistFrontEndData Playlist_Data, struct FText Playlist_CMS_Override, EFortLobbyType Lobby_Type)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaLobby.AthenaLobby_C.BndEvt__AthenaMatchmakingPlay_K2Node_ComponentBoundEvent");

	UAthenaLobby_C_BndEvt__AthenaMatchmakingPlay_K2Node_ComponentBoundEvent_Params params;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FName                   NewLobbyLevel                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaLobby_C::LoadNewLobbyLevel(struct FName NewLobbyLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaLobby.AthenaLobby_C.LoadNewLobbyLevel");

	UAthenaLobby_C_LoadNewLobbyLevel_Params params;
	params.NewLobbyLevel = NewLobbyLevel;
