...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.ReceiveTick");

	AJackalVehicle_Athena_C_ReceiveTick_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.HapticsOnTick");

	AJackalVehicle_Athena_C_HapticsOnTick_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.StopDriverRumble");

	AJackalVehicle_Athena_C_StopDriverRumble_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.StartDriverRumble");

	AJackalVehicle_Athena_C_StartDriverRumble_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.ReloadIfOnGamepad");

	AJackalVehicle_Athena_C_ReloadIfOnGamepad_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function JackalVehicle_Athena.JackalVehicle_Athena_C.CheckWater");

	AJackalVehicle_Athena_C_CheckWater_Params params;
