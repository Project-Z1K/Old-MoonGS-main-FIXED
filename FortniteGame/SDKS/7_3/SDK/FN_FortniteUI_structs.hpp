...
struct FLeaderboardFilter
{
	...
	class UDataTable*                                  LeaderboardDisplayData;                                   // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FBarrierObjectState
{
	...
	TEnumAsByte<EFortTeam>                             TeamNum;                                                  // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FAthenaPlaylistEntry
{
	...
	int                                                CropOffset;                                               // 0x0060(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EFortMatchmakingTileStyle                          SpecialBorderId;                                          // 0x0064(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShowRevealAnimation;                                     // 0x0065(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
