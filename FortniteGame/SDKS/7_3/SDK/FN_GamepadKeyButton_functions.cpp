...
void UGamepadKeyButton_C::BndEvt__InputActionWidget_K2Node_ComponentBoundEvent(bool bUsingGamepad)
{
	static auto fn = UObject::FindObject<UFunction>("Function GamepadKeyButton.GamepadKeyButton_C.BndEvt__InputActionWidget_K2Node_ComponentBoundEvent");

	UGamepadKeyButton_C_BndEvt__InputActionWidget_K2Node_ComponentBoundEvent_Params params;
