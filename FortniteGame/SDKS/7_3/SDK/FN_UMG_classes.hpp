...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0104(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	TArray<struct FAnimationEventBinding>              AnimationCallbacks;                                       // 0x01C8(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData04[0x50];                                      // 0x01D8(0x0050) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ContentColorAndOpacityDelegate;                           // 0x012C(0x0010) (ZeroConstructor, InstancedReference)
	struct FMargin                                     Padding;                                                  // 0x013C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FSlateBrush                                 StrikeBrush;                                              // 0x01D0(0x0088) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FVector2D                                   ShadowOffset;                                             // 0x0258(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                ShadowColorAndOpacity;                                    // 0x0260(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0270(0x0010) (ZeroConstructor, InstancedReference)
	float                                              MinDesiredWidth;                                          // 0x0280(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bWrapWithInvalidationPanel;                               // 0x0284(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoWrapText;                                            // 0x0285(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bSimpleTextMode;                                          // 0x0286(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x11];                                      // 0x0287(0x0011) MISSED OFFSET
...
public:
	...
	struct FScriptMulticastDelegate                    BP_OnItemClicked;                                         // 0x02E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    BP_OnItemDoubleClicked;                                   // 0x02F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    BP_OnItemIsHoveredChanged;                                // 0x0300(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    BP_OnItemSelectionChanged;                                // 0x0310(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    BP_OnItemScrolledIntoView;                                // 0x0320(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	float                                              EntryHeight;                                              // 0x0330(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              EntryWidth;                                               // 0x0334(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EListItemAlignment                                 TileAlignment;                                            // 0x0338(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWrapHorizontalNavigation;                                // 0x0339(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             BP_OnGetItemChildren;                                     // 0x0340(0x0010) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    BP_OnItemExpansionChanged;                                // 0x0350(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x011C(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0C44(0x0010) (Edit, ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData03[0x40];                                      // 0x0C78(0x0040) MISSED OFFSET
...
public:
	...
	struct FLinearColor                                ForegroundColor;                                          // 0x0998(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x09A8(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x09B8(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	struct FMargin                                     Padding;                                                  // 0x09D0(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x0378(0x0268) (Edit, BlueprintVisible)
	struct FInputChord                                 SelectedKey;                                              // 0x05E0(0x0020) (BlueprintVisible, BlueprintReadOnly)
	struct FSlateFontInfo                              Font;                                                     // 0x0600(0x0050) (Deprecated)
	struct FMargin                                     Margin;                                                   // 0x0650(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0660(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	struct FTextBlockStyle                             WidgetStyle;                                              // 0x0160(0x0268) (Edit, BlueprintVisible)
	bool                                               bIsReadOnly;                                              // 0x03C8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x03C9(0x0007) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x03D0(0x0050) (Deprecated)
	bool                                               SelectAllTextWhenFocused;                                 // 0x0420(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               ClearTextSelectionOnFocusLoss;                            // 0x0421(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               AllowContextMenu;                                         // 0x0424(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVirtualKeyboardOptions                     VirtualKeyboardOptions;                                   // 0x0425(0x0001) (Edit)
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x0426(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x0950(0x0268) (Edit, BlueprintVisible)
	bool                                               bIsReadOnly;                                              // 0x0BB8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x0BB9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVirtualKeyboardOptions                     VirtualKeyboardOptions;                                   // 0x0BBA(0x0001) (Edit)
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x0BBB(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0BBC(0x0004) MISSED OFFSET
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0BC0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x0BC8(0x0050) (Deprecated)
	struct FLinearColor                                ForegroundColor;                                          // 0x0C18(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0C28(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x0C38(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0C48(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0C58(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	unsigned char                                      UnknownData00[0x278];                                     // 0x0150(0x0278) MISSED OFFSET
	TArray<class URichTextBlockDecorator*>             InstanceDecorators;                                       // 0x03C8(0x0010) (ZeroConstructor, Transient)
