...
// Parameters:
// bool                           bOnFocusPath                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UChatWidget_C::OnWidgetIsOnFocusedPathChanged(bool bOnFocusPath)
{
	static auto fn = UObject::FindObject<UFunction>("Function ChatWidget.ChatWidget_C.OnWidgetIsOnFocusedPathChanged");

	UChatWidget_C_OnWidgetIsOnFocusedPathChanged_Params params;
	params.bOnFocusPath = bOnFocusPath;
