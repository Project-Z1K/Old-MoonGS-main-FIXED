...
public:
	...
	struct FScriptMulticastDelegate                    SpawnOutAnimEndedDispatcher;                              // 0x03B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
