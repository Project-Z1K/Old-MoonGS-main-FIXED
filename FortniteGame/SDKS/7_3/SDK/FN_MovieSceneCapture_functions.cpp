...
void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, struct FName BufferName, struct FScriptDelegate Handler)
{
...
void UUserDefinedCaptureProtocol::BindToStream(struct FName StreamName, struct FScriptDelegate Handler)
{
