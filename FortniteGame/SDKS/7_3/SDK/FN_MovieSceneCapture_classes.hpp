...
public:
	...
	void ResolveBuffer(class UTexture* Buffer, struct FName BufferName, struct FScriptDelegate Handler);
	...
	void BindToStream(struct FName StreamName, struct FScriptDelegate Handler);
};
