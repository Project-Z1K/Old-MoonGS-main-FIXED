...
public:
	...
	bool                                               bAllowFlushBackloggedAudio;                               // 0x0614(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               DynamicRateAdjustment;                                    // 0x0615(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
