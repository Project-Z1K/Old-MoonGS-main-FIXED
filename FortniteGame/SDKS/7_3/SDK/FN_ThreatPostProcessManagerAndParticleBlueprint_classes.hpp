...
public:
	...
	struct FScriptMulticastDelegate                    NewEventDispatcher;                                       // 0x0378(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	struct FScriptMulticastDelegate                    NewEventDispatcher0;                                      // 0x0388(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x03DB(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x2];                                       // 0x041E(0x0002) MISSED OFFSET
