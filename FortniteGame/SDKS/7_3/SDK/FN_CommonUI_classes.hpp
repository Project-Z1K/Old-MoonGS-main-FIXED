...
{
public:
	struct FScriptMulticastDelegate                    OnAnalogCapture;                                          // 0x04E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	bool                                               bConsumePointerInput;                                     // 0x0228(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnWidgetActivated;                                        // 0x0238(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnWidgetDeactivated;                                      // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x40];                                      // 0x0258(0x0040) MISSED OFFSET
	bool                                               bConsumeAllActions;                                       // 0x0298(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bExposeActionsExternally;                                 // 0x0299(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldBypassStack;                                       // 0x029A(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7D];                                      // 0x029B(0x007D) MISSED OFFSET
	...
	void SetInputActionHandlerWithProgressPopupMenu(struct FDataTableRowHandle InputActionRow, struct FScriptDelegate CommitedEvent, struct FScriptDelegate ProgressEvent, class UCommonPopupMenu* PopupMenu);
	void SetInputActionHandlerWithProgress(struct FDataTableRowHandle InputActionRow, struct FScriptDelegate CommitedEvent, struct FScriptDelegate ProgressEvent);
	void SetInputActionHandlerWithPopupMenu(struct FDataTableRowHandle InputActionRow, struct FScriptDelegate CommitedEvent, class UCommonPopupMenu* PopupMenu);
	void SetInputActionHandler(struct FDataTableRowHandle InputActionRow, struct FScriptDelegate CommitedEvent);
	void SetActionHandlerStateWithDisabledCommitEvent(class UDataTable* DataTable, struct FName RowName, EInputActionState State, struct FScriptDelegate DisabledCommitEvent);
	void SetActionHandlerStateFromHandleWithDisabledCommitEvent(struct FDataTableRowHandle InputActionRow, EInputActionState State, struct FScriptDelegate DisabledCommitEvent);
	...
	void AddInputActionHandlerWithProgressPopup(class UDataTable* DataTable, struct FName RowName, struct FScriptDelegate CommitedEvent, struct FScriptDelegate ProgressEvent, class UCommonPopupMenu* PopupMenu);
	void AddInputActionHandlerWithProgress(class UDataTable* DataTable, struct FName RowName, struct FScriptDelegate CommitedEvent, struct FScriptDelegate ProgressEvent);
	void AddInputActionHandlerWithPopup(class UDataTable* DataTable, struct FName RowName, struct FScriptDelegate CommitedEvent, class UCommonPopupMenu* PopupMenu);
	void AddInputActionHandler(class UDataTable* DataTable, struct FName RowName, struct FScriptDelegate CommitedEvent);
};
...
public:
	...
	struct FMargin                                     MinimumPadding;                                           // 0x026C(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                MinWidth;                                                 // 0x0230(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                MinHeight;                                                // 0x0234(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UClass*                                      Style;                                                    // 0x0238(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bHideInputAction;                                         // 0x0240(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0241(0x0007) MISSED OFFSET
	struct FSlateSound                                 PressedSlateSoundOverride;                                // 0x0248(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FSlateSound                                 HoveredSlateSoundOverride;                                // 0x0260(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bApplyAlphaOnDisable : 1;                                 // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bSelectable : 1;                                          // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bShouldSelectUponReceivingFocus : 1;                      // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bInteractableWhenSelected : 1;                            // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bToggleable : 1;                                          // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bDisplayInputActionWhenNotInteractable : 1;               // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bHideInputActionWithKeyboard : 1;                         // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bShouldUseFallbackDefaultInputAction : 1;                 // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0279(0x0001) MISSED OFFSET
	TEnumAsByte<EButtonClickMethod>                    ClickMethod;                                              // 0x027A(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EButtonTouchMethod>                    TouchMethod;                                              // 0x027B(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EButtonPressMethod>                    PressMethod;                                              // 0x027C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x027D(0x0003) MISSED OFFSET
	int                                                InputPriority;                                            // 0x0280(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0284(0x0004) MISSED OFFSET
	struct FDataTableRowHandle                         TriggeringInputAction;                                    // 0x0288(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0298(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSelectedChanged;                                        // 0x02A8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonClicked;                                          // 0x02B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonDoubleClicked;                                    // 0x02C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonHovered;                                          // 0x02D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonUnhovered;                                        // 0x02E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x30];                                      // 0x02F8(0x0030) MISSED OFFSET
	class UCommonActionWidget*                         InputActionWidget;                                        // 0x0328(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMaterialInstanceDynamic*                    SingleMaterialStyleMID;                                   // 0x0330(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FButtonStyle                                NormalStyle;                                              // 0x0338(0x0278)
	struct FButtonStyle                                SelectedStyle;                                            // 0x05B0(0x0278)
	struct FButtonStyle                                DisabledStyle;                                            // 0x0828(0x0278)
	unsigned char                                      bStopDoubleClickPropagation : 1;                          // 0x0AA0(0x0001) (Transient)
	unsigned char                                      UnknownData06[0x87];                                      // 0x0AA1(0x0087) MISSED OFFSET
...
public:
	...
	class UClass*                                      ScrollStyle;                                              // 0x02A0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool StopListeningForExistingHeldAction(struct FDataTableRowHandle InputActionDataRow, struct FScriptDelegate CompleteEvent, struct FScriptDelegate ProgressEvent);
	bool StartListeningForExistingHeldAction(struct FDataTableRowHandle InputActionDataRow, struct FScriptDelegate CompleteEvent, struct FScriptDelegate ProgressEvent);
...
{
public:
	class UClass*                                      ButtonType;                                               // 0x0230(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<class UCommonButton*>                       ActiveButtons;                                            // 0x0238(0x0010) (ExportObject, ZeroConstructor)
	TArray<class UCommonButton*>                       InactiveButtons;                                          // 0x0248(0x0010) (ExportObject, ZeroConstructor)
...
{
public:
	struct FSlateBrush                                 LoadingBackgroundBrush;                                   // 0x0200(0x0088) (Edit)
	struct FName                                       MaterialTextureParamName;                                 // 0x0288(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    BP_OnLoadingStateChanged;                                 // 0x0290(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	struct FSlateBrush                                 LoadingBackgroundBrush;                                   // 0x0100(0x0088) (Edit)
	class UUserWidget*                                 Content;                                                  // 0x0188(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0190(0x0028) MISSED OFFSET
	struct FScriptMulticastDelegate                    BP_OnLoadingStateChanged;                                 // 0x01B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FMargin                                     ThrobberPadding;                                          // 0x01A4(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FSoftObjectPath                             SpinnerMaterialPath;                                      // 0x01E8(0x0018) (ZeroConstructor, Config)
	...
	bool IsLoading();
	void BP_GuardAndLoadAsset(struct FScriptDelegate OnAssetLoaded);
};
...
{
public:
	struct FScriptMulticastDelegate                    OnOutroEvent;                                             // 0x02E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInterpolationEndedEvent;                                // 0x02F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	unsigned char                                      UnknownData01[0x36];                                      // 0x0332(0x0036) MISSED OFFSET
...
{
public:
	class UMenuAnchor*                                 PopupMenuAnchor;                                          // 0x0B28(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UCommonPopupMenu*                            PopupMenu;                                                // 0x0B30(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	bool                                               bUseInputStack;                                           // 0x0318(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0319(0x0003) MISSED OFFSET
	TWeakObjectPtr<class UMenuAnchor>                  OwningMenuAnchor;                                         // 0x031C(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UObject>                      ContextProvidingObject;                                   // 0x0324(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0B28(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnRotated;                                                // 0x0B38(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UCommonTextBlock*                            MyText;                                                   // 0x0B48(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnTabSelected;                                            // 0x0230(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTabButtonCreated;                                       // 0x0240(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTabButtonRemoved;                                       // 0x0250(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FDataTableRowHandle                         NextTabInputActionData;                                   // 0x0260(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FDataTableRowHandle                         PreviousTabInputActionData;                               // 0x0270(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bAutoListenForInput;                                      // 0x0280(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0281(0x0003) MISSED OFFSET
	TWeakObjectPtr<class UCommonWidgetSwitcher>        LinkedSwitcher;                                           // 0x0284(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x028C(0x0004) MISSED OFFSET
	TMap<struct FName, struct FCommonRegisteredTabInfo> RegisteredTabsByID;                                       // 0x0290(0x0050) (ZeroConstructor, Transient)
	class UCommonButtonGroup*                          TabButtonGroup;                                           // 0x02E0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<struct FCommonInputKeyDisplayConfiguration> InputKeyDataMap;                                          // 0x0038(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	struct FCommonInputKeyDisplayData                  ControllerImages;                                         // 0x0048(0x02A0) (Edit, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class CommonUI.CommonUIInputData");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData03[0x28];                                      // 0x0080(0x0028) UNKNOWN PROPERTY: SoftClassProperty CommonUI.CommonUISettings.InputData
	...
	class UClass*                                      InputDataClass;                                           // 0x0148(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	struct FMargin                                     ButtonPadding;                                            // 0x0108(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
