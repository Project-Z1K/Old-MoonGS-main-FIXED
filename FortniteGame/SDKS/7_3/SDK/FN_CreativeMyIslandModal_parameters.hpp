...
struct UCreativeMyIslandModal_C_BndEvt__UserActionMenuInputButton_Params
{
	class UCommonButton*                               Button;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// Function CreativeMyIslandModal.CreativeMyIslandModal_C.Construct
struct UCreativeMyIslandModal_C_Construct_Params
{
};

// Function CreativeMyIslandModal.CreativeMyIslandModal_C.BndEvt__Button
struct UCreativeMyIslandModal_C_BndEvt__Button_Params
{
};

// Function CreativeMyIslandModal.CreativeMyIslandModal_C.Setup Tabs
struct UCreativeMyIslandModal_C_Setup_Tabs_Params
{
};

// Function CreativeMyIslandModal.CreativeMyIslandModal_C.BndEvt__Permissions_K2Node_ComponentBoundEvent
struct UCreativeMyIslandModal_C_BndEvt__Permissions_K2Node_ComponentBoundEvent_Params
{
	class UCommonButton*                               Button;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};
