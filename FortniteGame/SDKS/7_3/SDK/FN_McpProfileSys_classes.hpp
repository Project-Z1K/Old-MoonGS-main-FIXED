...
public:
	...
	TArray<struct FProfileHttpRequest>                 PendingRequests;                                          // 0x0178(0x0010) (ZeroConstructor)
	...
	bool                                               bPendingInterceptedRequest;                               // 0x01D8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xF];                                       // 0x01D9(0x000F) MISSED OFFSET
	bool                                               bSendProfileCommandRevisions;                             // 0x01E8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAsyncParseProfileUpdates;                                // 0x01E9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x26];                                      // 0x01EA(0x0026) MISSED OFFSET
