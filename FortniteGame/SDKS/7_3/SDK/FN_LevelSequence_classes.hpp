...
{
public:
	struct FLevelSequencePlayerSnapshot                FrameInformation;                                         // 0x0228(0x0088) (BlueprintVisible, BlueprintReadOnly)
...
{
public:
	struct FScriptMulticastDelegate                    OnCameraCut;                                              // 0x07C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x90];                                      // 0x07D0(0x0090) MISSED OFFSET
