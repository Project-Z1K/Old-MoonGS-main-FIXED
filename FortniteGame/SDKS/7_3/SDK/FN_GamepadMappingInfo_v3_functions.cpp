...
{
	static auto fn = UObject::FindObject<UFunction>("Function GamepadMappingInfo_v3.GamepadMappingInfo_v3_C.Set Controller Image");

	UGamepadMappingInfo_v3_C_Set_Controller_Image_Params params;
