...
public:
	...
	struct FNiagaraParameterStore                      OverrideParameters;                                       // 0x0578(0x00E0) (Edit)
	unsigned char                                      bForceSolo : 1;                                           // 0x0658(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x27];                                      // 0x0659(0x0027) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0680(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0680(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x0680(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x1F];                                      // 0x0681(0x001F) MISSED OFFSET
	...
	unsigned char                                      UnknownData02[0x3D];                                      // 0x06B3(0x003D) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x13330];                                   // 0x0030(0x13330) MISSED OFFSET
