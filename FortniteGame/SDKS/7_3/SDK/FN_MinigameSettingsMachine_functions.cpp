...
{
	static auto fn = UObject::FindObject<UFunction>("Function MinigameSettingsMachine.MinigameSettingsMachine_C.SetGameModeToDeathmatch");

	AMinigameSettingsMachine_C_SetGameModeToDeathmatch_Params params;
