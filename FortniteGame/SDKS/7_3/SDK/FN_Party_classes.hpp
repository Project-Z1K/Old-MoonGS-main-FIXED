...
{
public:
	TMap<TWeakObjectPtr<class USocialUser>, class USocialPrivateMessageChannel*> DirectChannelsByTargetUser;                               // 0x0028(0x0050) (ZeroConstructor)
	TMap<struct FString, class USocialChatRoom*>       ChatRoomsById;                                            // 0x0078(0x0050) (ZeroConstructor)
	TMap<struct FString, class USocialReadOnlyChatChannel*> ReadOnlyChannelsByDisplayName;                            // 0x00C8(0x0050) (ZeroConstructor)
